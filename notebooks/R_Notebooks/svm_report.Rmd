...
here::i_am('notebooks/R_Notebooks/svm_report.Rmd')
library(here)
...
knitr::include_graphics(here('notebooks/R_Notebooks/images/Sensor Illustration.png'))
```
...
knitr::include_graphics(here('notebooks/R_Notebooks/images/Accuracy.png'))
```
...
knitr::include_graphics(here('notebooks/R_Notebooks/images/Sitting on Bed Predictions.png'))
```
...
knitr::include_graphics(here('notebooks/R_Notebooks/images/Laying Predictions.png'))
```
...
knitr::include_graphics(here('notebooks/R_Notebooks/images/Walking Predictions.png'))
```
...
knitr::include_graphics(here('notebooks/R_Notebooks/images/Sitting on Chair Predictions.png'))
```
